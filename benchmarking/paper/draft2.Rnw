...
\item quantifying chemical reactions or microbial growth in 96-well plates (e.g., \cite{szymula_open-source_2019})
\item growing and evolving bacteria (e.g. \cite{takahashi_low_2015}) 
