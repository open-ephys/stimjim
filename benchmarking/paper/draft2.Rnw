...
\hline
                                &             &              & STG400x                           & PHM-15x                  &  \\
                                & Stimjim     & PulsePal     & (Multichannel Systems)            & (Med associates)         & ISO-O1B (NPI) \\
\hline
 Number of output channels      & 2           & 4            &  2-8                              & 2                        & 1             \\ 
 Stimulus generator included?   & X           & X            &  X                                & X                        &               \\  
 Current output mode            & X           &              &  X                                & X                        & X                        \\
 Voltage output mode            & X           & X            &  X                                &                          & X                        \\
 Outputs electrically isolated  & X           &              &  X                                & X                        & X                        \\
 Onboard measurement            & X           &              &                                   & Optional                 & X (compliance warning)   \\
 Compliance voltage             & $\pm$ 13.7V & $\pm$ 15V    & $\pm$ 120V                        & $\pm$ 45V                & $\pm$ 100V     \\
 Fastest pulse                  & 50us        & 10us         & 20us                              & 60us                     & 10us           \\
 Cost (USD)                     & \$194       & \$200        & \$4131 (2 channels)               &  \$6211 (plus \$4438     & \$1708         \\
...
plot(x2,y2, main='Current accuracy', xlab='Target amplitude (uA)', ylab='measured amplitude (uA)', cex=0.75, col='red')
abline(a=0,b=1)
